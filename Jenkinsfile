  ...
  node(POD_LABEL) {
   withCredentials([
     ...
     string(credentialsId: 'ras-cleanup-github-api-token', variable: 'GITHUB_API_TOKEN')
        ...
        'PROJECTS=cash-k8s,beobachter-k8s-buildperf,handelszeitung-k8s-buildperf,beobachter-k8s,expero-k8s,gaultmillau-k8s,handelszeitung-k8s,schweizer-illustrierte-k8s,streaming-k8s,illustre-k8s,pme-k8s,tele-k8s']) {
